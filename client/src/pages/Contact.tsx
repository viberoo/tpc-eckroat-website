      ...
      <section className="bg-[#f7f4ec] py-20 lg:py-28">
        <div className="container">
          ...
          <div className="mt-10 grid border-t border-[#bdb6a8] sm:grid-cols-3">
            ...
            <a
              href="https://www.google.com/maps/search/?api=1&query=4268+N+Boulevard+Suite+132+Edmond+OK+73034"
              target="_blank"
              rel="noreferrer"
            ...
            >
              ...
              <span>
                ...
                <span className="contact-value">4268 N Boulevard, Suite 132<br />Edmond, OK 73034</span>
              </span>
